...
Start your terminal and type the following command to verify that **Git** is ready to be used on your computer:
...
Committing is the process in which the changes are _'officially'_ added to the Git repository.
...
<aside>
ℹ️ Read more about branching and merging

[on this link](https://git-scm.com/book/en/v2/Git-Branching-Basic-Branching-and-Merging).
